...
from apps.products.models import DetailsRequestStatus, Product
from apps.products.services import ensure_details_request, mark_requests_pending
...
def test_mark_requests_pending_updates_status(db):
    p1 = Product.objects.create(artid="A1", brand="B", pin="P", oem="", name="n", source="armtek")
    p2 = Product.objects.create(artid="A2", brand="B", pin="P2", oem="", name="n2", source="armtek")
